  ...
  return (
    <div className="w-full md:w-1/2 lg:w-1/3 p-4" key={data.id}>
      <div className="h-full bg-gray-100 rounded-2xl">
        <div className="w-full rounded-2xl" style={{height: '300px', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundImage: `url(https://strapi-g45m.onrender.com${imageUrl})`}}/>
        <div className="p-8">
